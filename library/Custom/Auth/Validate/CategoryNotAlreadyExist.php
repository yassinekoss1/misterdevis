...
class Custom_Auth_Validate_CategoryNotAlreadyExist extends Zend_Validate_Abstract
{
    ...
    public function isValid($value)
    {
		...
		$company = $_em->getRepository('Auth_Model_Category')->findByNamecategory($value);
	    $isValid = true;
