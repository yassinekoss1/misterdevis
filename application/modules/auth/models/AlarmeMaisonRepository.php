...
/**
 * Class Auth_Model_AlarmeMaisonRepository
 *
 * @author  Youssef Erratbi <yerratbi@gmail.com>
 * @date    23/12/17
 */
class Auth_Model_AlarmeMaisonRepository extends EntityRepository {
  ...
  public function save( $id_demande = null, $data ) {
     ...
     * @var \Auth_Model_Climatisation $qualification;
     *
     */
    ...
    if ( ! $demande ) {
      ...
      $activite =  $this->_em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'libelle' => 'CLIMATISATION' ] );
    ...
    if ( ! $qualification ) {
      $qualification = new Auth_Model_AlarmeMaison();
    }
    
    
    // Populating qualificaiton object
    foreach ( $data['AlarmeMaison'] as $key => $val ) {
