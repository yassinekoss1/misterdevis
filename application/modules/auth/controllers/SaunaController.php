...
/**
 * Class Auth_SaunaController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité Sauna,
 * il permet de lister les demande de devis concernant la sauna avec l'action indexAction,
 ...
 */
class Auth_SaunaController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'SAUNA HAMMAM';
  private $slug       = 'sauna';
  private $name       = 'Sauna';
  private $form_name  = 'Auth_Form_Sauna';
  private $model_name = 'Auth_Model_Sauna';
  ...
  public function indexAction() {
    ...
    $this->view->demandes = $em->getRepository( 'Auth_Model_Sauna' )->getList();
  }
  ...
  public function notificationAction() {
    ...
    $this->view->count = (int) $this->getRequest()->_em->getRepository( 'Auth_Model_Sauna' )->getNotifications( true );
    ...
    $this->view->notifications = $this->getRequest()->_em->getRepository( 'Auth_Model_Sauna' )->getNotifications();
    
    // Preparing data to send back
    $data = [
      'count' => $this->view->count,
      'html'  => $this->view->render( "sauna/notification.phtml" ),
    ];
  ...
  public function sendSMSNotification( $artisans, $ref ) {
    ...
    $content = "Bonjour, 1 nouveau chantier, pour l'installation d'une Sauna : " . $ref . ", est disponible près de chez vous. Vous avez reçu 1 mail et vous pouvez maintenant le découvrir sur www.mister-devis.com. ";
  ...
  public function addAction() {
    ...
    $form->addSubForms( [
      ...
      'form_qualif'      => new Auth_Form_Sauna,
  ...
  public function editAction() {
    ...
    if ( ! $demande ) {
      ...
      $activite = $em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'libelle' => 'SAUNA HAMMAM' ] );
    ...
    $form->setDefaults( [
      ...
      'Sauna'       => $qualification ? $qualification->toArray() : null,
    ] );
    ...
    if ( $this->getRequest()->isPost() ) {
      ...
      if ( $valid && $zone !== null ) {
        ...
        $qualification = $em->getRepository( 'Auth_Model_Sauna' )->save( $id, $data );
        ...
        $this->getResponse()->setRedirect( "/auth/sauna" );
