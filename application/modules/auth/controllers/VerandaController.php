 ...
 */
class Auth_VerandaController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'VER';
  private $slug       = 'veranda';
  private $name       = 'Veranda';
  private $form_name  = 'Auth_Form_Veranda';
  private $model_name = 'Auth_Model_Veranda';
  ...
  public function sendSMSNotification( $artisans, $ref ) {
    ...
    $content = "Bonjour, 1 nouveau chantier, pour l'installation d'une Véranda : " . $ref . ", est disponible près de chez vous. Vous avez reçu 1 mail et vous pouvez maintenant le découvrir sur www.mister-devis.com.";
