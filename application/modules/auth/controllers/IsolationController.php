...
/**
 * Class Auth_IsolationController
 *
 ...
 */
class Auth_IsolationController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ISO';
  private $slug       = 'isolation';
  private $name       = 'Isolation';
  private $form_name  = 'Auth_Form_Isolation';
  private $model_name = 'Auth_Model_Isolation';
  ...
  public function sendSMSNotification( $artisans, $ref ) {
    ...
    $content = "Bonjour, 1 nouveau chantier, pour la mise en place d'une isolation : " . $ref . ", est disponible près de chez vous. Vous avez reçu 1 mail et vous pouvez maintenant le découvrir sur www.mister-devis.com.";
