...
/**
 * Class Auth_Abri_piscineController
 *
 ...
 */
class Auth_AbriPiscineController extends Zend_Controller_Action {
  
  private $_sys_email;
  private $type       = 'ABP';
  private $slug       = 'abriPiscine';
  private $name       = 'AbriPiscine';
  private $form_name  = 'Auth_Form_AbriPiscine';
  private $model_name = 'Auth_Model_AbriPiscine';
  ...
  public function sendSMSNotification( $artisans, $ref ) {
    ...
    $content = "Bonjour, 1 nouveau chantier, pour l'installation d'une Abri Piscine : " . $ref . ", est disponible près de chez vous. Vous avez reçu 1 mail et vous pouvez maintenant le découvrir sur www.mister-devis.com.";
