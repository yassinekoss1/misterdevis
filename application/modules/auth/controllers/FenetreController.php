...
/**
 * Class Auth_FenetreController
 *
 * @authors  Youssef Erratbi <yerratbi@gmail.com>  - Aziz Idmansour <aziz.idmansour@gmail.com>
 * @date     23/12/17
 * Ce controlleur est responsable sur la gestion de l'activité fenêtre,
 * il permet de lister les demande de devis concernant la fenêtre avec l'action indexAction,
...
class Auth_FenetreController extends Zend_Controller_Action {
  ...
  private $slug       = 'fenetre';
  private $name       = 'Fenetre';
  private $form_name  = 'Auth_Form_Fenetre';
  private $model_name = 'Auth_Model_Fenetre';
  ...
  public function indexAction() {
    ...
    $this->view->demandes = $em->getRepository( 'Auth_Model_Fenetre' )->getList();
  }
  ...
  public function notificationAction() {
    ...
    $this->view->count = (int) $this->getRequest()->_em->getRepository( 'Auth_Model_Fenetre' )->getNotifications( true );
    ...
    $this->view->notifications = $this->getRequest()->_em->getRepository( 'Auth_Model_Fenetre' )->getNotifications();
    
    // Preparing data to send back
    $data = [
      'count' => $this->view->count,
      'html'  => $this->view->render( "fenetre/notification.phtml" ),
    ];
  ...
  public function sendSMSNotification( $artisans, $ref ) {
    ...
    $content = "Bonjour, 1 nouveau chantier, pour l'installation d'une Fenêtre : " . $ref . ", est disponible près de chez vous. Vous avez reçu 1 mail et vous pouvez maintenant le découvrir sur www.mister-devis.com. ";
  ...
  public function addAction() {
    ...
    $form->addSubForms( [
      ...
      'form_qualif'      => new Auth_Form_Fenetre,
  ...
  public function editAction() {
    ...
    if ( ! $demande ) {
      ...
      $activite = $em->getRepository( 'Auth_Model_Activite' )->findOneBy( [ 'libelle' => 'FENETRE' ] );
    ...
    // Load qualification
    $qualification = $em->getRepository( 'Auth_Model_Fenetre' )->findOneBy( [ 'id_demande' => $id ] );
