			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("Sélectionner les fichiers") + '</div>' +
						'<div class="plupload_header_text">' + _("Ajouter des fichiers à la file d'attente de téléchargement et appuyez sur le bouton 'Démarrer l'envoi") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('Nom du fichier') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('État') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('Taille') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("Déposez les fichiers ici.") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("Ajouter des fichiers") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("Démarrer l'envoi") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_("Arrêter l'envoi.") + '</a>&nbsp;' +
						'</div>' +
		...
		uploader.bind('Error', function(up, err) {			
			...
			switch (err.code) {
				...
				case self.FILE_COUNT_ERROR:
					details = o.sprintf(_("Que %d fichier(s) peuvent être envoyé(s) à la fois. Les fichiers supplémentaires ont été ignorés."), up.getOption('filters').max_file_count || 0);
					break;
				...
				case plupload.HTTP_ERROR:
					details = _("L'URL d'envoi est soit erronée soit n'existe pas.");
					break;
			}
	...
	notify: function(type, message) {
		var popup = $(
			'<div class="plupload_message">' + 
				'<span class="plupload_message_close ui-icon ui-icon-circle-close" title="'+_('Fermer')+'"></span>' +
	...
	*/
	...
	_handleState: function() {
		...
		if (plupload.STARTED === up.state) {			
			...
			$('.plupload_upload_status', this.element).html(o.sprintf(_('%d fichiers sur %d ont été envoyés'), up.total.uploaded, up.files.length));
